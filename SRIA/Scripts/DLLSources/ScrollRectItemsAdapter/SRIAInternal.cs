...
namespace frame8.Logic.Misc.Visual.UI.ScrollRectItemsAdapter
{
	...
	IEnumerator SmoothScrollProgressCoroutine(
			...
			Func<float, bool> onProgress = null, Func<float, float> overrideEaseFunction = null)
		{
			...
			do
			{
				...
				else
				{
					...
					{
						progress = overrideEaseFunction(elapsedTime / duration);
					}
				}
