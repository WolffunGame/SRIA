...
namespace frame8.Logic.Misc.Visual.UI.ScrollRectItemsAdapter
{
	...
	public interface ISRIA : IScrollRectProxy
	{
		...
		/// <summary>See <see cref="SRIA{TParams, TItemViewsHolder}.IsDragging"/></summary>
		bool IsDragging { get; }
		...
		bool SmoothScrollTo(int itemIndex, float duration, float normalizedOffsetFromViewportStart = 0f, float normalizedPositionOfItemPivotToUse = 0f, Func<float, bool> onProgress = null, bool overrideCurrentScrollingAnimation = false, Func<float, float> overrideEaseFunction = null);
