...
namespace frame8.Logic.Misc.Visual.UI.ScrollRectItemsAdapter
{
	...
	where TItemViewsHolder : BaseItemViewsHolder
	{
		...
		{
			return _InternalState.viewportSize;
		}
		...
		public virtual bool SmoothScrollTo(int itemIndex, float duration, float normalizedOffsetFromViewportStart = 0f, float normalizedPositionOfItemPivotToUse = 0f, Func<float, bool> onProgress = null, bool overrideCurrentScrollingAnimation = false, Func<float, float> overrideEaseFunction = null)
		{
			...
			_SmoothScrollCoroutine = StartCoroutine(SmoothScrollProgressCoroutine(itemIndex, duration, normalizedOffsetFromViewportStart, normalizedPositionOfItemPivotToUse, onProgress, overrideEaseFunction));
		...
		public float ConvertItemInsetFromParentStart_FromVirtualToReal(double virtualInsetFromParrentStart)
		{ return _InternalState.ConvertItemInsetFromParentStart_FromVirtualToReal(virtualInsetFromParrentStart); }
