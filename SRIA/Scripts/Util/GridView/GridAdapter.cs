...
//#pragma warning disable 809 // Obsolete member 'memberA' overrides non-obsolete member 'memberB'
		...
		public sealed override bool SmoothScrollTo(int cellIndex, float duration, float normalizedOffsetFromViewportStart = 0f, float normalizedPositionOfItemPivotToUse = 0f, Func<float, bool> onProgress = null, bool overrideAnyCurrentScrollingAnimation = false, Func<float, float> overrideEaseFunction = null)
		{ return SmoothScrollToGroup(_Params.GetGroupIndex(cellIndex), duration, normalizedOffsetFromViewportStart, normalizedPositionOfItemPivotToUse, onProgress, overrideAnyCurrentScrollingAnimation, overrideEaseFunction); }
//#pragma warning restore 809
		...
		public virtual bool SmoothScrollToGroup(int groupIndex, float duration, float normalizedOffsetFromViewportStart = 0f, float normalizedPositionOfItemPivotToUse = 0f, Func<float, bool> onProgress = null, bool overrideAnyCurrentScrollingAnimation = false, Func<float, float> overrideEaseFunction = null)
		{ return base.SmoothScrollTo(groupIndex, duration, normalizedOffsetFromViewportStart, normalizedPositionOfItemPivotToUse, onProgress, overrideAnyCurrentScrollingAnimation, overrideEaseFunction); }
		#endregion
